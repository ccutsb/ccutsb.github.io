...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    es: {
      ...
      "hero.roleAlt": "Técnico en Informática",
      "hero.subtitle":
      ...
      "projects.subtitle": "Soluciones tecnológicas que he desarrollado",
      ...
      "contact.form.service": "¿Qué tipo de servicio necesitas?",
      "contact.form.webDesign": "Diseño Web",
      "contact.form.webDev": "Desarrollo Web",
      "contact.form.backend": "Desarrollo Backend",
      "contact.form.consulting": "Consultoría",
      "contact.form.support": "Soporte Informático",
      "contact.form.other": "Otro",
      "contact.form.message": "Mensaje",
      "contact.form.submit": "Enviar Mensaje",
      "contact.form.sending": "Enviando...",
      "contact.form.success": "Envío exitoso. Gracias por contactarme!",
      "contact.form.error": "Error en el envío. Intenta nuevamente más tarde.",
      "contact.form.network": "Error en el envío. Revisa tu conexión e intenta de nuevo.",
      ...
      "footer.db": "Optimización de Bases de Datos",
      "footer.devops": "Consultoría DevOps",
      ...
      "projectsPage.ctaBody":
        "Estoy disponible para nuevos proyectos. Contactame y hablemos sobre como puedo ayudarte a construir soluciones tecnológicas.",
