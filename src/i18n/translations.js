  ...
  es: {
    ...
    hero: {
      ...
      typed: [
        ...
        "automatizo tareas con Python",
        "doy soporte IT en terreno",
    ...
    footer: {
      tagline: "hecho con React + Vite, desplegado en GitHub Pages",
  ...
  en: {
    ...
    hero: {
      ...
      typed: [
        ...
        "I automate tasks with Python",
        "I do hands-on IT support",
    ...
    footer: {
      tagline: "built with React + Vite, deployed on GitHub Pages",
